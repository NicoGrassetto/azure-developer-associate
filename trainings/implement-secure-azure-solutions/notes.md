...
|-----------------------------------|----------------|
| .NET | App Configuration [provider](https://learn.microsoft.com/en-us/dotnet/api/microsoft.extensions.configuration.azureappconfiguration?view=azure-dotnet) for .NET |
